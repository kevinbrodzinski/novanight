...
UP_HOST=os.getenv('DUSB04_UPSTREAM_HOST','127.0.0.1'); UP_PORT=int(os.getenv('DUSB04_UPSTREAM_PORT','8080')); LISTEN=int(os.getenv('PORT','9091'))
class H(BaseHTTPRequestHandler):
    ...
    def _go(self):
        ...
        try:
            c.request(self.command,self.path,body=body,headers=headers); r=c.getresponse(); data=r.read(); self.send_response(r.status)
